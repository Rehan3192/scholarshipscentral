...
export default function FinderStepField({
  ...
  return (
    <section className="space-y-4" aria-labelledby="finder-field-heading">
      <div>
        <h2 id="finder-field-heading" tabIndex={-1} className="text-xl font-semibold text-slate-900 focus:outline-none">
          Field of Study
        </h2>
      ...
      <div className="space-y-1">
        <label htmlFor="finder-field" className="text-sm font-medium text-slate-700">
          Field
        </label>
        <input
          id="finder-field"
      ...
      <button
        type="button"
        onClick={onSkip}
        className="inline-flex items-center rounded-lg border border-slate-300 bg-white px-4 py-2 text-sm font-semibold text-slate-900 hover:bg-slate-50 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-offset-2"
      >
        Skip
      </button>
    </section>
