...
const BADGE_STYLES: Record<FinderRecommendation["recommendationLevel"], string> = {
  ...
  "Not Recommended": "border-slate-200 bg-slate-50 text-slate-700",
};
  ...
  return (
    <article className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
      ...
      <div className="mt-4 grid gap-4 lg:grid-cols-[1fr_1fr_220px]">
        <div>
          <h4 className="m-0 text-xs font-bold uppercase tracking-wide text-slate-500">
            Why this matches
          </h4>
          <ul className="mt-2 ml-0 list-none space-y-1 text-sm text-slate-700">
        ...
        <div>
          ...
          {recommendation.warnings.length > 0 ? (
            <ul className="mt-3 ml-0 list-none space-y-1 text-sm text-slate-700">
