...
export const metadata: Metadata = {
  title: "PhD Scholarships | Scholarships Central",
  description:
    "Explore fully funded and partially funded PhD scholarships for international students worldwide.",
  alternates: {
    canonical: "/degrees/phd",
  },
};

export default function PhDScholarshipsPage() {
  const filtered = scholarships.filter((s) => s.degreeLevel === "PhD");
  ...
  return (
    <div className="space-y-6">
      ...
      />
      <ItemListJsonLd pagePath="/degrees/phd" items={items} />
      ...
      <header className="space-y-2">
        ...
        <p className="mb-0 text-sm text-gray-600">
          Browse scholarships at the PhD level. We only link to official
          external application pages.
        </p>
        <div className="pt-2">
          <ScholarshipFilterBar
            baseHref="/scholarships"
            primaryLabel="Filter: PhD"
            params={{ degree: "PhD" }}
          />
        </div>
      </header>
