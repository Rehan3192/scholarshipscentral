...
export const metadata: Metadata = {
  title: "Master's Scholarships | Scholarships Central",
  description:
    "Explore fully funded and partially funded Master's scholarships for international students worldwide.",
  alternates: {
    canonical: "/degrees/masters",
  },
};

export default function MastersScholarshipsPage() {
  const filtered = scholarships.filter((s) => s.degreeLevel === "Masters");
    ...
    <div className="space-y-6">
      <BreadcrumbJsonLd
        items={[
          ...
          { label: "Master's Scholarships", href: "/degrees/masters" },
        ]}
      />
      <ItemListJsonLd pagePath="/degrees/masters" items={items} />
      ...
      <header className="space-y-2">
        ...
        <p className="mb-0 text-sm text-gray-600">
          Browse scholarships at the Masters level. We only link to official
          external application pages.
        </p>
        <div className="pt-2">
          <ScholarshipFilterBar
            baseHref="/scholarships"
            primaryLabel="Filter: Masters"
            params={{ degree: "Masters" }}
          />
        </div>
      </header>
