...
export const metadata: Metadata = {
  title: "Scholarships in Germany | Scholarships Central",
  description:
    "Browse fully funded and partially funded scholarships in Germany for international students with official application links.",
  alternates: {
...
export default function GermanyScholarshipsPage() {
  const filtered = scholarships.filter((s) => s.country === "Germany");
    ...
    <div className="space-y-6">
      <BreadcrumbJsonLd
        items={[
          ...
          { label: "Scholarships in Germany", href: "/countries/germany" },
        ]}
      />
      ...
      <header className="space-y-2">
        ...
        <p className="mb-0 text-sm text-gray-600">
          Explore scholarships available in Germany. We only link to official
          external application pages.
        </p>
        <div className="pt-2">
          <ScholarshipFilterBar
            baseHref="/scholarships"
            primaryLabel="Filter: Germany"
