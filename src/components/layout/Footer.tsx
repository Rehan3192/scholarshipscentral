...
export default function Footer() {
  ...
  const linkClassName =
    "rounded-sm text-sm font-semibold text-slate-700 hover:text-blue-700 hover:underline focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-offset-2";

  return (
    <footer className="mt-16 border-t border-blue-100 bg-gradient-to-b from-white via-blue-50/40 to-slate-50">
      <div className="mx-auto max-w-6xl px-4 py-12">
        <div className="overflow-hidden rounded-3xl border border-blue-200/90 bg-gradient-to-br from-white via-blue-50/60 to-emerald-50/40 p-6 shadow-2xl shadow-blue-950/[0.08] ring-1 ring-white/70 sm:p-8">
          <div
            className="pointer-events-none -mt-20 ml-auto h-28 w-28 rounded-full bg-blue-200/40 blur-3xl"
            aria-hidden="true"
          />
          ...
          <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-[1.2fr_1fr_1fr]">
            <div className="space-y-3">
              ...
              <Link
                ...
                className="inline-flex w-fit items-center rounded-2xl bg-slate-950 px-4 py-2 text-sm font-semibold text-white shadow-lg shadow-slate-950/15 transition-colors duration-200 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-offset-2 motion-reduce:transition-none"
              >
            ...
            <div className="space-y-3">
              <div className="text-sm font-bold uppercase tracking-[0.14em] text-slate-950">
                Browse
              </div>
          ...
          <div className="mt-10 flex flex-col gap-3 border-t border-blue-200/70 pt-6 text-xs text-slate-500 sm:flex-row sm:items-center sm:justify-between">
